...
for image_filename in image_filenames:
    ...
    while line_count < 14:
        ...
        # 在画布上绘制红色直线
        cv2.line(canvas, (0, random_coordinate), (223, random_coordinate), (0, 0, 255), 1)
    ...
    canvas_path = os.path.join(image_dir, canvas_filename)
